...
mainVector[result4]
studentResult4 <-mainVector[result4]
studentResult4

# question 5
result5 <- c(9,10)
# generate vector result5 subsetting mainVector using > or >= and store it as a new vector "studentResult5"
  studentResult5 <- mainVector > 8
  mainVector[studentResult5]
  studentResult5 <-  mainVector[studentResult5]
  studentResult5
# question 6
...
mainVector[result7]
studentResult7 <-mainVector[result7]
studentResult7
...
mainVector[result8]
studentResult8 <- mainVector[result8]
studentResult8
...
mainVector[result9]
studentResult9 <- mainVector[result9]
studentResult9
